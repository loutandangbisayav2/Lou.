 module.exports = {
  config: {
    name: "autoreact",
    author: "Kaizenji",// converted from mirai autoreact.js
    version: "1.0",
    countDown: 1,
    role: 0,
  ...
  onChat: async function ({ event, api }) {
    ...
    const reactionsMap = {
      ...
      "❤️": ["love", "mahal", "crush", "sarap", "ugh", "pogi", "iyot", "kantot", "kiss", "ganda", "babe", "baby", "darling", "labyu", "eve", "morning", "good", "aft", "❤️", "🥰", "😘", "😍", "🤩", "gm", "gn", "mwa", "mwua", "mwhehe", "nice", "mahusay", "galing", "miss", "bot", "jaycee", "kaizen", "pusa"],
      ...
      "😮": ["wow", "waw", "shish", "sheesh", "angas", "lakas", "lopit", "mamaw", "pro", "god", "mod apk", "hakir", "haker", "hacker", "noway", "omahghadd", "omg", "bro", "💀", "😮", "🥶", "😱", "😲", "⁉️", "‼️", "🔥", "main karaktir", "karaktir"],
      "🔥": ["eyy", "fire"]
